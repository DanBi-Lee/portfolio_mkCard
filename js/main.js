...
"use strict";function _toConsumableArray(t){return _arrayWithoutHoles(t)||_iterableToArray(t)||_unsupportedIterableToArray(t)||_nonIterableSpread()}function _nonIterableSpread(){throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function _unsupportedIterableToArray(t,e){if(t){if("string"==typeof t)return _arrayLikeToArray(t,e);var r=Object.prototype.toString.call(t).slice(8,-1);return"Object"===r&&t.constructor&&(r=t.constructor.name),"Map"===r||"Set"===r?Array.from(t):"Arguments"===r||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)?_arrayLikeToArray(t,e):void 0}}function _iterableToArray(t){if("undefined"!=typeof Symbol&&Symbol.iterator in Object(t))return Array.from(t)}function _arrayWithoutHoles(t){if(Array.isArray(t))return _arrayLikeToArray(t)}function _arrayLikeToArray(t,e){(null==e||e>t.length)&&(e=t.length);for(var r=0,i=new Array(e);r<e;r++)i[r]=t[r];return i}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var AutoSlider=function t(e){var r=this,i=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0;_classCallCheck(this,t),this.init=function(){r.animation(),r.handlingAnimation()},this.animation=function(){r.timer=requestAnimationFrame(r.move)},this.stopAnimation=function(){window.cancelAnimationFrame(r.timer)},this.move=function(){r.left>r.image_width&&(r.left=0,r.$imageBox.appendChild(_toConsumableArray(r.$imageBox.querySelectorAll("li"))[0])),r.left+=1,r.$imageBox.style.left="".concat(-r.left,"px"),r.animation()},this.handlingAnimation=function(){r.$imageBox.addEventListener("mouseenter",r.stopAnimation),r.$imageBox.addEventListener("mouseleave",r.animation)},this.$imageBox=document.querySelector(e),this.$imageLi=this.$imageBox.querySelector("li"),this.image_width=parseInt(window.getComputedStyle(this.$imageLi).width),console.log(this.image_width),this.left=i,this.init()},_default=AutoSlider;exports.default=_default;

},{}],333:[function(require,module,exports){
"use strict";var _autoSlider=_interopRequireDefault(require("./autoSlider")),_myParallex=_interopRequireDefault(require("./myParallex")),_wheelMotion=_interopRequireDefault(require("./wheelMotion"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}var myParallex=new _myParallex.default('[id$="Box"]',150),wheelMotion=new _wheelMotion.default('[id$="Box"]'),imageSlider=new _autoSlider.default(".box_img ul");

},{"./autoSlider":332,"./myParallex":334,"./wheelMotion":338}],334:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var _debouncing=_interopRequireDefault(require("./util/debouncing")),_throttling=_interopRequireDefault(require("./util/throttling"));function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _toConsumableArray(t){return _arrayWithoutHoles(t)||_iterableToArray(t)||_unsupportedIterableToArray(t)||_nonIterableSpread()}function _nonIterableSpread(){throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function _unsupportedIterableToArray(t,e){if(t){if("string"==typeof t)return _arrayLikeToArray(t,e);var n=Object.prototype.toString.call(t).slice(8,-1);return"Object"===n&&t.constructor&&(n=t.constructor.name),"Map"===n||"Set"===n?Array.from(t):"Arguments"===n||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?_arrayLikeToArray(t,e):void 0}}function _iterableToArray(t){if("undefined"!=typeof Symbol&&Symbol.iterator in Object(t))return Array.from(t)}function _arrayWithoutHoles(t){if(Array.isArray(t))return _arrayLikeToArray(t)}function _arrayLikeToArray(t,e){(null==e||e>t.length)&&(e=t.length);for(var n=0,o=new Array(e);n<e;n++)o[n]=t[n];return o}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _defineProperties(t,e){for(var n=0;n<e.length;n++){var o=e[n];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(t,o.key,o)}}function _createClass(t,e,n){return e&&_defineProperties(t.prototype,e),n&&_defineProperties(t,n),t}var throttling=new _throttling.default,debouncing=new _debouncing.default,MyParallex=function(){function t(e,n){var o=this;_classCallCheck(this,t),this._setPositionList=function(t){var e=t.map(function(t){return t.offsetTop});return e.push(t[t.length-1].offsetTop+t[t.length-1].clientHeight+o.posRange),console.log(e),e},this.init=function(){o._handlingResize(),o._handlingScroll()},this._handlingScroll=function(){window.addEventListener("scroll",function(t){throttling.throttle(o._scrollAnimation,200)})},this._scrollAnimation=function(){var t=window.scrollY;o._scrollingEffect(),o._activate(t)},this._scrollAnimationTimer=null,this._scrollingEffect=function(){o.$body.classList.add("scrolling"),o._scrollAnimationTimer&&clearTimeout(o._scrollAnimationTimer),o._scrollAnimationTimer=setTimeout(function(){o.$body.classList.remove("scrolling")},300)},this._activate=function(t){for(var e=0;e<o.positionList.length;e++)t>=o.positionList[e]-o.posRange&&t<o.positionList[e+1]-o.posRange&&(o.boxList.forEach(function(t){t.classList.remove("on")}),o.boxList[e].classList.add("on"),"introduceBox"===o.boxList[e].id?document.querySelector("#mainBox .pic").classList.add("on"):document.querySelector("#mainBox .pic").classList.remove("on"))},this.boxList=_toConsumableArray(document.querySelectorAll(e)),this.$body=document.querySelector("body"),this.posRange=n,this.positionList=[],window.addEventListener("load",function(){o.positionList=o._setPositionList(o.boxList)}),this.init()}return _createClass(t,[{key:"_handlingResize",value:function(){var t=this,e=function(){console.log("실행"),setTimeout(function(){t.positionList=t._setPositionList(t.boxList)},1e3)};window.addEventListener("resize",function(){return debouncing.debounce(e)})}}]),t}(),_default=MyParallex;exports.default=_default;

},{"./util/debouncing":336,"./util/throttling":337}],335:[function(require,module,exports){
"use strict";function ownKeys(e,t){var r=Object.keys(e);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(e);t&&(n=n.filter(function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable})),r.push.apply(r,n)}return r}function _objectSpread(e){for(var t=1;t<arguments.length;t++){var r=null!=arguments[t]?arguments[t]:{};t%2?ownKeys(Object(r),!0).forEach(function(t){_defineProperty(e,t,r[t])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(r)):ownKeys(Object(r)).forEach(function(t){Object.defineProperty(e,t,Object.getOwnPropertyDescriptor(r,t))})}return e}function _defineProperty(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _defineProperties(e,t){for(var r=0;r<t.length;r++){var n=t[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}function _createClass(e,t,r){return t&&_defineProperties(e.prototype,t),r&&_defineProperties(e,r),e}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0,require("babel-polyfill");var Animation=function(){function e(t){var r=this;_classCallCheck(this,e),this.options={duration:1e3,prop:"margin-left",value:200},this.animation=function(e){return new Promise(function(t){r.options=_objectSpread(_objectSpread({},r.options),e),r.start=performance.now();var n=1*r.$target.scrollY;requestAnimationFrame(function e(r){var a=r-o.start;var i=a/o.options.duration;i<0&&(i=0);i>1&&(i=1);if(!(i<1))return void t(cancelAnimationFrame(o.timer));o.timer=requestAnimationFrame(e);var c=n+(o.options.value-n)*o.easeOutBack(i);o.$target[o.options.prop](0,c)});var o=r})},this.$target=t}return _createClass(e,[{key:"easeOutBack",value:function(e){var t=Math.pow;return 1+2.70158*t(e-1,3)+1.70158*t(e-1,2)}}]),e}(),_default=Animation;exports.default=_default;

},{"babel-polyfill":1}],336:[function(require,module,exports){
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var _debouncing=_interopRequireDefault(require("./util/debouncing")),_animation=_interopRequireDefault(require("./util/animation"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _toConsumableArray(e){return _arrayWithoutHoles(e)||_iterableToArray(e)||_unsupportedIterableToArray(e)||_nonIterableSpread()}function _nonIterableSpread(){throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function _unsupportedIterableToArray(e,t){if(e){if("string"==typeof e)return _arrayLikeToArray(e,t);var r=Object.prototype.toString.call(e).slice(8,-1);return"Object"===r&&e.constructor&&(r=e.constructor.name),"Map"===r||"Set"===r?Array.from(e):"Arguments"===r||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)?_arrayLikeToArray(e,t):void 0}}function _iterableToArray(e){if("undefined"!=typeof Symbol&&Symbol.iterator in Object(e))return Array.from(e)}function _arrayWithoutHoles(e){if(Array.isArray(e))return _arrayLikeToArray(e)}function _arrayLikeToArray(e,t){(null==t||t>e.length)&&(t=e.length);for(var r=0,n=new Array(t);r<t;r++)n[r]=e[r];return n}function asyncGeneratorStep(e,t,r,n,o,i,a){try{var u=e[i](a),c=u.value}catch(e){return void r(e)}u.done?t(c):Promise.resolve(c).then(n,o)}function _asyncToGenerator(e){return function(){var t=this,r=arguments;return new Promise(function(n,o){var i=e.apply(t,r);function a(e){asyncGeneratorStep(i,n,o,a,u,"next",e)}function u(e){asyncGeneratorStep(i,n,o,a,u,"throw",e)}a(void 0)})}}function ownKeys(e,t){var r=Object.keys(e);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(e);t&&(n=n.filter(function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable})),r.push.apply(r,n)}return r}function _objectSpread(e){for(var t=1;t<arguments.length;t++){var r=null!=arguments[t]?arguments[t]:{};t%2?ownKeys(Object(r),!0).forEach(function(t){_defineProperty(e,t,r[t])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(r)):ownKeys(Object(r)).forEach(function(t){Object.defineProperty(e,t,Object.getOwnPropertyDescriptor(r,t))})}return e}function _defineProperty(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}require("babel-polyfill");var debouncing=new _debouncing.default,animation=new _animation.default(window),WheelMotion=function e(t){var r=this;_classCallCheck(this,e),this.$body=document.querySelector("body"),this.MIN_SIZE=900,this.enableActive=!0,this.init=function(){r.onMouseWheel()},this.onMouseWheel=function(){r.$body.addEventListener("wheel",function(e){return debouncing.debounce(r.motion.call(null,e),200)},{passive:!1})},this.motionCondition=function(e){var t=window.innerWidth>=r.MIN_SIZE,n=!!e.target.closest(r.selector);return t&&n},this.motion=function(e){if(r.motionCondition(e)){e.preventDefault();var t={duration:1e3,prop:"scroll",value:null},n=r.boxList.indexOf(e.target.closest(r.selector));e.deltaY>0&&0!==n&&n!==r.boxList.length-1?r.animation(_objectSpread(_objectSpread({},t),{},{value:r.boxList[n+1].offsetTop})):e.deltaY<0&&n>1&&r.animation(_objectSpread(_objectSpread({},t),{},{value:r.boxList[n-1].offsetTop}))}},this.animation=function(){var e=_asyncToGenerator(regeneratorRuntime.mark(function e(t){return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(r.enableActive){e.next=2;break}return e.abrupt("return");case 2:return r.enableActive=!1,e.next=5,animation.animation(t);case 5:r.enableActive=!0;case 6:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}(),this.selector=t,this.boxList=_toConsumableArray(document.querySelectorAll(t)),this.init()},_default=WheelMotion;exports.default=_default;

},{"./util/animation":335,"./util/debouncing":336,"babel-polyfill":1}]},{},[333]);
